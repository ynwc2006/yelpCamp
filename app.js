if(process.env.NODE_ENV !=="production"){ //in 'develop' mode ,will show it in the file
...
const sessionConfig={
    ...
    cookie:{
        httpOnly:true,
        //secure:true, only work for https instead of http
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/djki2muxd/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
